...
public class Asiakkaat extends HttpServlet {
	...
	//Asikkaan hakeminen, haetaan asiakkaiden tiedot
...
//		}		
	...
	protected void doPut(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		PrintWriter out = response.getWriter();
		Dao dao = new Dao();			
		if(dao.muutaAsiakas(asiakas, vanhaasiakas_id)){ //metodi palauttaa true/false, metodille välitetään asiakkaan uudet tiedot sekä vanhan asiakas_id:n
